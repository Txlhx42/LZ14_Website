<template>
  <div class="operational-unit">
    <div class="content">
      ...
      <div class="squad-leaders-section">
        <div class="section-header">
          <h2>Truppführer/-innen</h2>
        </div>
        <ul class="member-list">
          <li>
      ...
      <div class="squad-members-section">
        <div class="section-header">
          <h2>Feuerwehrfrauen und -männer</h2>
        </div>
        <ul class="member-list">
          <li>
            <img src="@/assets/ranks/ofm.png" alt="OFM" class="rank-image" />
      ...
      <div class="candidates-section">
        <div class="section-header">
          <h2>Anwärterinnen und Anwärter</h2>
        </div>
        <ul class="member-list">
          <li>
      ...
      <div class="rank-info">
        <hr class="divider" />
        <p>
          Eine Übersicht über die bei der Freiwilligen Feuerwehr in
          Nordrhein-Westfalen gebräuchlichen Dienstgrade und die dazugehörigen
          Abzeichen findet sich
          <a
            href="https://de.wikipedia.org/wiki/Dienstgrade_der_Feuerwehr_in_Nordrhein-Westfalen"
            target="_blank"
